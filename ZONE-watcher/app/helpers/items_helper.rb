module ItemsHelper
  def getButtonForFilter(filter)
    ...
    if(filter.prop.starts_with? @OPEN_CALAIS_URI)
      ...
      res= link_to filter.value, itemURI, :class =>  itemClassFilter, title: filter.value
      ...
      if(filter.value.rindex('/') == nil)
        ...
        res=link_to filter.value[filter.value.rindex('/')+1, filter.value.length], itemURI, :class => itemClassFilter, title: filter.value[filter.value.rindex('/')+1, filter.value.length]
      end
      ...
      res=link_to filter.value[filter.value.rindex('/')+1, filter.value.length], itemURI, :class => itemClassFilter, title: filter.value
